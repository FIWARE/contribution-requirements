...
provide a visual aid to understand different aspects about a project. Badges can be easily generated by using [http://shields.io/ Shields.io]. Where Shields.io already offers a badge it should be used in preference to other badges. 
