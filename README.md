...
Enabler (GE) as well as the recommended practices for the development of FIWARE
GEs.
...
The Guide assumes that the reader knows the basics of Github, Travis, test
driven development and continuous integration. If that is not the case please
